...
{
	echo '<tr><td>'.$row['tblStudentId'].'</td><td>'.$row['studentname'].'</td><td><form action="reportor.php" method="post"><input type="hidden" name="txtstud" id="txtstud" value="'.$row["tblStudentId"].'"/><button type="submit" class="btn btn-success">Generate Report</button></form></td></tr>';
}
echo '</tbody>';	
?>