...
if(isset($_POST['btnFri']))
{
	$day=$_POST['txtFriDay'];
	$sectid=$_POST['txtFriSectId'];
	$subjcode=$_POST['txtFriSubjCode'];
	$subj=$_POST['txtFriSubj'];
	$start=$_POST['txtFriStart'];
	$end=$_POST['txtFriEnd'];
...
function fnTime($a, $b, $id, $subjId)
	{
		include "db_connect.php";
		$query="update tblsched set tblSchedStartOfSubj='$a', tblSchedEndOfSubj='$b' where tblSched_tblSectionId='$id' and tblSched_tblSubjectId='$subjId' and tblSchedDay='FRIDAY'";
