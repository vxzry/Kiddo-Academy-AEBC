        ...
        <div class="box-body">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#tab_2" data-toggle="tab">No. of Days of Classes</a></li>
            </ul>
...
?> 
    ...
    <div class="form-inline" style="margin-bottom: 1%"
            ...
            <select class="form-control" style="width: 30%" name="getSySelect" id="getSySelect" onchange="showTblMonth();">
  ...
  <div class="modal fade" id="updateModalTwo" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h3 class="modal-title" style="font-style: bold">Update Number of Days of Classes</h3>
        </div>
        <form method="post" action="updateNumberDays.php">
        <div class="modal-body">
        
        <div class="form-group">
            <div><input type="text" name="NumClassId" id="NumClassId" hidden></div>
            <label class="col-sm-4 control-label" for="textinput" style="text-align: right">Month</label>
            <div class="col-sm-7">
              <input type="text" placeholder="Month" name="updNumMonth" id="updNumMonth" class="form-control">
            </div>
        </div>
        <div class="form-group" style="margin-top: 10%">
                <label class="col-sm-4" style="text-align: right">Number of Days</label>
                <div class="col-sm-7">
                <input class="rem" type="number" min="1" max="31" name="updNumDay" id="updNumDay">
                </div>
        </div>          
        </div>
        <div class="modal-footer" style="margin-top: 10%">
        <button type="submit" class="btn btn-info" name="submitNumClass" id="submitNumClass">Save</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
        </form>
      </div>
  ...
  <div class="modal fade" id="resetModalTwo" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h3 class="modal-title" style="font-style: bold">Reset Number of Days</h3>
        </div>
        <form action="resetNumberDays.php" method="post">
        <div class="modal-body">
        
        <h4 align="center">Are you sure you want to reset?</h4>
        <input type="text" value="<?php echo $key;?>" <?php echo $selected;?> name="resetInp"/>
        </div>
        <div class="modal-footer" style="margin-top: 5%; float: center">
        <button type="submit" class="btn btn-danger" id="btnResetNumClass" name="btnResetNumClass">Yes</button>
          <button type="button" class="btn btn-info" data-dismiss="modal">No</button>
              ...
              <table id="datatable1" class="table table-bordered table-striped">
                ...
                <td style="width:100px;"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#updateModalTwo"><i class="fa fa-edit"></i></button>
