          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <thead>
                ...
                <tbody>
                  <?php
                    $query="select s.tblStudentId, concat(si.tblStudInfoLname, ', ', si.tblStudInfoFname, ' ', si.tblStudInfoMname) as name, s.tblStudentType from tblstudent s, tblstudentinfo si where s.tblStudentId=si.tblStudInfo_tblStudentId and s.tblStudentFlag=1 and si.tblStudInfoFlag=1 and s.tblStudentType='OFFICIAL'";
                    $result=mysqli_query($con, $query);
                    while($row=mysqli_fetch_array($result)):
                  ?>
                <tr>
                  ...
                  <td></td>
                     <td><form method="post" action="reportcontactlist.php"><button type="submit" class="btn btn-success"> Generate Report </button><input type="hidden" name="txtstud" id="txtstud" value="<?php echo $row['tblStudentId'] ?>"/></form></td>
                  </tr>
                  <?php endwhile; ?>
                  </tbody>
              </table>
