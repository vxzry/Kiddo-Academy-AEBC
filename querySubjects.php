...
<head>
  ...
  {
    var lvl = document.getElementById("addDivSelect").value;
    var xmlhttp =  new XMLHttpRequest();
    xmlhttp.open("GET","changeDivSect.php?addDivSelect="+document.getElementById("addDivSelect").value,false);
    xmlhttp.send(null);
    
    document.getElementById("selLevel").innerHTML=xmlhttp.responseText;
    document.getElementById("selLevel").disabled=false;
  }
  function changeTblSect()
  {
    var lvl = document.getElementById("selLevel").value;
    var xmlhttp =  new XMLHttpRequest();
    xmlhttp.open("GET","changeTblSubj.php?selLevel="+document.getElementById("selLevel").value,false);
    xmlhttp.send(null);
