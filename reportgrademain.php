            ...
            <!-- form start -->
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td></td>
                     <td><form method="post" action="reportgrade.php"><input type="hidden" name="txtsect" id="txtsect" value="<?php echo $row['tblSectionId'] ?>"/><button type="submit" class="btn btn-success"> Generate Report </button></form></td>
                  </tr>
                  <?php endwhile; ?>
                  </tbody>
              </table>
