...
if(isset($_POST['btnTues']))
{
	$day=$_POST['txtTuesDay'];
	$sectid=$_POST['txtTuesSectId'];
	$subjcode=$_POST['txtTuesSubjCode'];
	$subj=$_POST['txtTuesTuesSubj'];
	$start=$_POST['txtTuesStart'];
	$end=$_POST['txtTuesEnd'];
...
function fnTime($a, $b, $id, $subjId)
	{
		include "db_connect.php";
		$query="update tblsched set tblSchedStartOfSubj='$a', tblSchedEndOfSubj='$b' where tblSched_tblSectionId='$id' and tblSched_tblSubjectId='$subjId' and tblSchedDay='TUESDAY'";
