...
if(isset($_POST['btnUpdMon']))
{
	$day=$_POST['txtDay'];
	$sectid=$_POST['txtSectId'];
	$subjcode=$_POST['txtSubjCode'];
	$subj=$_POST['txtSubj'];
...
function fnTime($a, $b, $id, $subjId)
	{
		include "db_connect.php";
		$query="update tblsched set tblSchedStartOfSubj='$a', tblSchedEndOfSubj='$b' where tblSched_tblSectionId='$id' and tblSched_tblSubjectId='$subjId' and tblSchedDay='MONDAY'";
