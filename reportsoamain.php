...
<head>
  ...
  function changetblSOA()
  {
    ...
    xmlhttp.open("GET","changeTblSOA.php?selLevel="+document.getElementById("selLevel").value,false);
    xmlhttp.send(null);
          ...
          <div class="box box-primary">
            ...
            <form role="form">
              ...
              <thead>
                ...
                if($rolename=='PARENT')
                {
                  $query="select s.tblStudentId, concat(si.tblStudInfoLname, ', ', si.tblStudInfoFname, ' ', si.tblStudInfoMname) as studname, s.tblStudentType from tblstudent s join tblstudentinfo si on si.tblStudInfo_tblStudentId=s.tblStudentId join tblparentstudent ps on s.tblStudentId=ps.tblParStud_tblStudentId where ps.tblParStud_tblParentId='$id' and s.tblStudentFlag=1 and s.tblStudentType='OFFICIAL'";
                  $result=mysqli_query($con, $query);
                }else{
                $query="select s.tblStudentId, concat(si.tblStudInfoLname, ', ', si.tblStudInfoFname, ' ', si.tblStudInfoMname) as studname, s.tblStudentType from tblstudent s, tblstudentinfo si where s.tblStudentId=si.tblStudInfo_tblStudentId and s.tblStudentFlag=1 and si.tblStudInfoFlag=1 and s.tblStudentType='OFFICIAL'";
                $result=mysqli_query($con, $query);
                }
                while($row=mysqli_fetch_array($result)):
                ?>
