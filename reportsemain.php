            ...
            <!-- form start -->
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td><?php echo $row['tblSchoolYrYear'] ?></td>
                  <td><?php echo $row['tblSchoolYrActive'] ?></td>
                     <td><form method="post" action="reportSummaryEnrollment.php"><input type="hidden" name="txtsy" id="txtsy" value="<?php echo $row['tblSchoolYrId'] ?>"/><button type="submit" class="btn btn-success"> Generate Report </button></form></td>
                  </tr>
                  <?php endwhile; ?>
                  </tbody>
              </table>
