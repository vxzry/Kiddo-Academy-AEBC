...
if(isset($_POST['btnThurs']))
{
	$day=$_POST['txtThursDay'];
	$sectid=$_POST['txtThursSectId'];
	$subjcode=$_POST['txtThursSubjCode'];
	$subj=$_POST['txtThursSubj'];
	$start=$_POST['txtThursStart'];
	$end=$_POST['txtThursEnd'];
...
function fnTime($a, $b, $id, $subjId)
	{
		include "db_connect.php";
		$query="update tblsched set tblSchedStartOfSubj='$a', tblSchedEndOfSubj='$b' where tblSched_tblSectionId='$id' and tblSched_tblSubjectId='$subjId' and tblSchedDay='THURSDAY'";
