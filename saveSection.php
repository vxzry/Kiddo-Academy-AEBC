...
if(isset($_POST['addSectBtn']))
{
	...
	if ($result->num_rows == 0)
	{
		...
		if($result->num_rows == 0)
		{
			...
			$query = "insert ignore into `tblsection`(`tblSectionId`, `tblSectionName`, `tblSection_tblLevelId`, `tblSectionFlag`, `tblSectionSession`) values ('$sectid', '$section', '$lvlSel', 1, '$session')";
			$result = mysqli_query($con, $query);
